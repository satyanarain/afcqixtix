...
class AuditStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('report.returncrewstock.index', compact('stocks'));
    }
    ...
    public function create()
    {
        ...
        return view('report.returncrewstock.create',compact('items_data','paperticket', 'depots', 'series', 'crews'));
    }
    ...
    public function store(StoreReturnCrewStockRequest $request)
    {
        ...
        return redirect()->route('report.returncrewstock.index');
    }
    ...
    public function edit($id)
    {
        ...
        $series = CenterStock::where('series', '!=', '')->orderBy('series', 'asc')->distinct('series')->pluck('series', 'series');
        return view('report.crewstock.edit',compact('items_data','paperticket', 'depots', 'stock', 'series'));
    }
    ...
    public function update(UpdateReturnCrewStockRequest $request, $id)
    {
        ...
        return redirect()->route('report.crewstock.index');
    }
