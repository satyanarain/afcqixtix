...
class DepotSummaryController extends Controller
{
    use activityLog;
    use checkPermission;
    ...
    {
        return view('reports.ppt.depot_summary.index');
    }
    ...
    {       
        ...
        return view('reports.ppt.depot_summary.index', compact('data'));
    }
    ...
    public function getPdfReport(Request $request)
    {
        ...
        $title = 'Depot Summary Report'; // Report title
    ...
    {
        $queryBuilder = DepotSummary::with(['denomination:id,description,price', 'item:id,description', 'depot:id,name']);
