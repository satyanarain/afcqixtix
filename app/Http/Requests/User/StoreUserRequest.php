...
class StoreUserRequest extends Request
{
    ...
    public function messages(){
        return [
            ...
            'passport_document.required' => 'The Passport Document field is required.',
            ...
            'national_id_document.required' => 'The National ID Document field is required.',
        	'beneficiary_country.required' => 'The Beneficiary Country field is required.',
            'dob.date' => 'The Date of Birth field must be date'
        ];
    }
}
