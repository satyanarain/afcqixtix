...
$routes_id = Route::create(['approval_status'=>'p','flag'=>'a','route_master_id'=>$requestData->route_master_id,'version_id'=>$requestData->version_id,'user_id'=>$user_id,'route'=>$requestData->route,'source'=>$requestData->source,'destination'=>$requestData->destination,'via'=>$requestData->via,'direction'=>$requestData->direction,'default_path'=>$requestData->default_path,'is_this_by'=>$requestData->is_this_by])->id;
