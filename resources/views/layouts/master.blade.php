...
<head>
 ...
 <link rel="stylesheet" href="{{ asset(elixir('css/bootstrap.min.css')) }}">
  ...
  <link rel="stylesheet" href="{{ asset(elixir('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')) }}">
    ...
    <link href="/fullcalendar/dist/fullcalendar.print.css" media="print" rel="stylesheet">
    <!-- full calendar js and css ends-->
    <!-- css and js for select with search box starts -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/css/select2.min.css" rel="stylesheet" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/js/select2.min.js"></script>
    <!-- css and js for select with search box ends -->
    ...
    <script type="text/javascript" src="{{ URL::asset('js/patent.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/industrialdesign.js') }}"></script>
...
<i class="fa fa-circle-o"></i> @lang('menu.settings.users') 
</a></li>
