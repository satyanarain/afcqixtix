    ...
    <div class="col-xs-12">
      <div class="box">
            <div class="box-header">
               ...
               <?php $permission_status = checkPermission('cash_collections','create');
                    if($permission_status)
                        echo '<a href="'.route('waybills.new_cash_collection').'"><button class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;Add</button></a>';
            ...
            <td>
                <select data-column="2"  class="search-input-select">
                    ...
                    <thead>
                        <tr>
                            <th class=""></th>
                            <th>@lang('Abstract No.')</th>
                            <th>@lang('Amount Payable')</th>
                            <th>@lang('Manua1 Payout')</th>
                            <th>@lang('Cash Remitted')</th>
                            <th>@lang('Cash Challan No.')</th>
    ...
    var dataTable = $('#waybill-grid').DataTable( {
       ...
       // "pageLength": 1000,
        ...
        "ajax":{
               ...
               url :"{{ route('waybills/getfilteredcashcollection') }}", // json datasource
