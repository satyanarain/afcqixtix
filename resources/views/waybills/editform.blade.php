...
<div class="form-group ">
    ...
    <div class="col-md-7 col-sm-12">
       ...
       {!! Form::select('bus_type_id', $routes,isset($waybills->route_id) ? $waybills->route_id : selected,
        ['class' => 'col-md-6 form-control', 'placeholder'=>'Select Route','required' => 'required','onchange'=>'fillDropdown("service_id","services","name","bus_type_id")']) !!}
    </div>
...
<div class="form-group ">
    ...
    <div class="col-md-7 col-sm-12">
        {!! Form::select('driver_id', $crew,isset($waybills->driver_id) ? $waybills->driver_id : selected,
...
<div class="form-group ">
    ...
    <div class="col-md-7 col-sm-12">
        {!! Form::select('conductor_id', $crew,isset($waybills->conductor_id) ? $waybills->conductor_id : selected,
