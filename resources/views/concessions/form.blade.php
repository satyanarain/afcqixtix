...
<div class="form-group">
  ...
  {!! Form::select('concession',$concession_masters, isset($concessions->concession) ? $concessions->concession :selected,['class' => 'form-control','placeholder'=>'Select Concession','required'=>'required']) !!}
</div>
<div class="form-group">
...
<div class="form-group">
     @php $pass_type_masters=displayList('pass_type_masters','name')@endphp
      {!! Form::label('pass_types', Lang::get('Pass Type'), ['class' => 'control-label']) !!}<br>
         {!! Form::select('pass_types',$pass_type_masters, isset($concessions->pass_types) ? $concessions->pass_types :selected,['class' => 'form-control','placeholder'=>'Select Pass Type']) !!}
</div>
<div class="form-group">
