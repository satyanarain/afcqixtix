    ...
    <div class="col-xs-12">
      <div class="box">
            <div class="box-header">
               <h3 class="box-title">Crew Stock Inventory Details </h3>
                <?php 
                $permission_status = checkPermission('crewstocks','create');
                if($permission_status)
                {?>
                <a class="btn btn-afcs pull-right" href="{{route('inventory.crewstock.create')}}"><span class="fa fa-plus"></span> Assign</a>
                <?php   }?>
