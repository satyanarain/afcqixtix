             ...
             <div class="modal-body-view">
                 ...
                 <form autocomplete="off">
                     <table class="table table-responsive.view">
                         ...
                         <tr>
                             ...
                             <td align="left" valign="top"><span id="{{"showdepots".$value->id}}" 
                                     ...
                                     <table class="table_normal_100">
                                         <tr>
                                             <td><?php echo $value->depots; ?><input type="checkbox" name="depots[]" value="create" @if(in_array('create',explode(',',$value->depots)))checked @endif>&nbsp;&nbsp;Add</td>
                         ...
                         <tr>
                             <td><b>
                                      <input type="checkbox" name="bus_types[]" value="{{$value->bus_types}}" @if(in_array('bus_types',explode(',',$value->bus_types)))checked @endif onchange="showMenu(this.id)" id={{'bus_types'.$value->id}}>
                                     
                                     &nbsp;&nbsp;Bus Type</b></td>
                             <td><span 
                                       id="{{"showbus_types".$value->id}}" 
                                                                 @if(in_array('bus_types',explode(',',$value->depots)))
                                                                 @else
                                                                 class="display_none"
                                                                 @endif
                                       > 
                                     <table  class="table_normal_100">
                                        <tr>
                                             <td><input type="checkbox" name="bus_types[]" value="create" @if(in_array('create',explode(',',$value->bus_types)))checked @endif>&nbsp;&nbsp;Add</td>
