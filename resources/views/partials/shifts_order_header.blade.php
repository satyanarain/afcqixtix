...
<script>
   ...
   {
   var urldata=   '/shifts/' + view_detail + '/' +id;
...
function updateOrder() {	
	...
	$.ajax({
		type: "GET",
		url: "/shifts/sort_order/"+order_string,
		data: order_string,
		cache: false,
		success: function(data){
