        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary" style="min-width:10%;">
            <div class="box-body box-profile" style="padding:8px 0 1px 1px;">
              ...
              <input type="hidden" id="user_id" value="{{ $bustypes->id }}">
              <h3 class="profile-username text-center cursor-pointer" id="user_name"><span id="user-name-span">{{ $bustypes->bus_type }}</span> <span id="edit-user-name" class="glyphicon glyphicon-pencil"></span></h3>


              <p class="text-muted text-center">{{ $bustypes->display_name }}</p>
               ...
               <table width=90% class="table table-responsive">
                     ...
                     <tr>
                                     ...
                                     <td style="text-align:left;padding-left:15%;padding-top:3%; "><span></span>{{ $bustypes->abbreviation }}</span></td>
                                   </tr>
                     <tr>
                    <td style="text-align:left;padding-left:10%;padding-top:3%;"><b>Order Number</b></td>
                    <td style="text-align:left;padding-left:15%;padding-top:3%; ">{{ $bustypes->order_number }}</td>
                  </tr>
...
<!--                  <tr>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            @if($bustypes->user_type == 1 || $bustypes->user_type == 4 || $bustypes->user_type == 9)
