          ...
          <div class="col-md-3">
              ...
              <div class="box box-primary" style="min-width:10%;">
                  <div class="box-body box-profile" style="padding:8px 0 1px 1px;">
                      ...
                      <input type="hidden" id="user_id" value="{{ $vehicles->id }}">
...
<!--                          <span id="edit-user-name" class="glyphicon glyphicon-pencil"></span>-->
                       ...
                       <table width=90% class="table table-responsive">
                          <tr>
                              ...
                              <td style="text-align:left;padding-left:15%;padding-top:3%; "><span></span>{{ $vehicles->bus_type }}</span></td>
                          </tr>
                          <tr>
                              <td style="text-align:left;padding-left:10%;padding-top:3%;"><b>Name</b></td>
                              <td style="text-align:left;padding-left:15%;padding-top:3%; "><span></span>{{ $vehicles->name }}</span></td>
                          </tr>
                          <tr>
                              <td style="text-align:left;padding-left:10%;padding-top:3%;"><b>Short Name</b></td>
                              <td style="text-align:left;padding-left:15%;padding-top:3%; "><span></span>{{ $vehicles->short_name }}</span></td>
                          </tr>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            @if($vehicles->user_type == 1 || $vehicles->user_type == 4 || $vehicles->user_type == 9)
