...
<!--                    <button type="button" class="close" data-dismiss="alert">×</button>	-->
                ...
                <ul class="list-group-order-main">
                    <li class="order-sub"><a href="javascript:void(0);">Inspector Remarks</a>
                        <a href="javascript:void(0);">Order Number</a>
                        <a href="javascript:void(0);">Short Remarks</a>
                        <a href="javascript:void(0);">Remarks Description</a>
                    </li>  </ul>
                <ul class="list-group-order" id="order_list">
                    <?php //echo orderList('inspector_remarks', 'id', 'bus_type', 'order_number', 'abbreviation'); ?>
                </ul>
         </div>
...
function orderList(order_id,order_list)
   {
   var urldata=   '/inspector_remarks/' + order_list;
   ...
   {
   var urldata=   '/inspector_remarks/' + view_detail + '/' +id;
    $.ajax({
		type: "GET",
		url: urldata,
		cache: false,
...
function updateOrder() {	
	...
	$.ajax({
		type: "GET",
		url: "/inspector_remarks/sort_order/"+order_string,
		data: order_string,
		cache: false,
		success: function(data){
