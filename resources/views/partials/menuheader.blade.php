            ...
            <div class="modal-header-view">
             ...
             <div class="modal-body-view">
                ...
                <table class="table table-responsive.view">
                    ...
                    <tr>
                        <td><b>{!! Form::checkbox('depots[]','depots',false,['onchange'=>"showMenu(this.id)",'id'=>'depots'.$value->id]) !!}&nbsp;&nbsp;Depot</b></td>
                        <td align="left" valign="top"><span id="{{"showdepots".$value->id}}" class="display_none">
                                <table  style="width:100%;font-weight:normal;">
                                    <tr>
                         <td>{!! Form::checkbox('depots[]','add',false) !!} Add</td>
                        <td>{!! Form::checkbox('depots[]','edit',false) !!}&nbsp;&nbsp;Edit</td>
                        <td>{!! Form::checkbox('depots[]','view',false) !!}&nbsp;&nbsp;View</td>
                                    </tr>   
                                </table>  
                         </span>
                        </td>
                    ...
                    <tr>
                       ...
                       <table  style="width:100%;font-weight:normal;">
                                    <tr>
                         <td>{!! Form::checkbox('bus_types[]','add',false) !!} Add</td>
