                          ...
                          $.each(trips, function(trindex, trip){
                            ...
                            if(tickets)
                            {
                              ...
                              $.each(tickets, function(tiindex, ticket){
                                ...
                                if(i%2 == 0)
                                {
                                    reportData.push([{'text':''+ticket.ticket_number, style:'oddRowStyle'}, {'text':''+ticket.to_stop.stop, style:'oddRowStyle'}, {'text':''+ticket.sold_at, style:'oddRowStyle', alignment:'right'}, {'text':''+ticket.adults, style:'oddRowStyle', alignment:'right'}, {'text':''+parseFloat(ticket.adults_amt).toFixed(2), style:'oddRowStyle', alignment:'right'}, {'text':''+ticket.childs, style:'oddRowStyle', alignment:'right'}, {'text':''+parseFloat(ticket.childs_amt).toFixed(2), style:'oddRowStyle', alignment:'right'}, {'text':''+parseFloat(ticket.concession_amt).toFixed(2), style:'oddRowStyle', alignment:'right'}, {'text':'', style:'oddRowStyle', alignment:'right'}, {'text':'', style:'oddRowStyle', alignment:'right'}, {'text':'', style:'oddRowStyle', alignment:'right'}, {'text':''+parseFloat(ticket.total_amt).toFixed(2), style:'oddRowStyle', alignment:'right'}, {'text':'', style:'oddRowStyle', alignment:'right'}, {'text':''+ticket.card_number, style:'oddRowStyle', alignment:'right'}, {'text':''+parseFloat(ticket.epurse_balance).toFixed(2), style:'oddRowStyle', alignment:'right'}]);
                                }else{
                                    reportData.push([{'text':''+ticket.ticket_number}, {'text':''+ticket.to_stop.stop}, {'text':''+ticket.sold_at, alignment:'right'}, {'text':''+ticket.adults, alignment:'right'}, {'text':''+parseFloat(ticket.adults_amt).toFixed(2), alignment:'right'}, {'text':''+ticket.childs, alignment:'right'}, {'text':''+parseFloat(ticket.childs_amt).toFixed(2), alignment:'right'}, {'text':''+parseFloat(ticket.concession_amt).toFixed(2), alignment:'right'}, {'text':''+parseFloat(0).toFixed(2), alignment:'right'}, {'text':''+parseFloat(0).toFixed(2), alignment:'right'}, {'text':''+parseFloat(0).toFixed(2), alignment:'right'}, {'text':''+parseFloat(ticket.total_amt).toFixed(2), alignment:'right'}, {'text':''}, {'text':''+ticket.card_number, alignment:'right'}, {'text':''+parseFloat(ticket.epurse_balance).toFixed(2), alignment:'right'}]);
                                }
                                i++;
                              })
                            }
