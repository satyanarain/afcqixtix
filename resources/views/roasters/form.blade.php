                        ...
                        <div class="roaster_crew_container">
                            @foreach($crews as $crew)
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="<?=$i?><?=$shift->id?>-crew-<?=$crew->id?>"><?=$crew->crew_name?></label>
                                </div>
                            @endforeach
                        </div>
                    </td>
                        ...
                        <div class="roaster_crew_container">
                            @foreach($crews as $crew)
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="<?=$i?><?=$shift->id?>-crew-off-<?=$crew->id?>"><?=$crew->crew_name?></label>
                                    </div>
                            @endforeach
                        </div>
                    </td>
