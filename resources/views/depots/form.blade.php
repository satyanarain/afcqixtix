...
<div class="form-group">
    @php $services_value=displayList('services','name')@endphp
      ...
      {!! Form::label('service_id', Lang::get('Default Service'), ['class' => 'col-md-3 control-label']) !!}
       <div class="col-md-7 col-sm-12 required">
       {!! Form::select('service_id',$services_value,isset($depot->service_id) ? $depot->service_id : selected,['class' => 'form-control','required' => 'required','onchange'=>'fareList(this.value)','placeholder'=>"Select Service"]) !!}
</div> 
</div> 
<div class="form-group">
    <div class="col-md-3" style="margin-right: 15px;"></div>
    {{ Form::submit('Save', array('class' => 'btn btn-success pull-left','required' => 'required')) }}
    <div class="col-md-3" style="margin-right: 15px;">{{ Form::button('Cancel', array('class' => 'btn btn-primary pull-left','onclick'=>'window.history.back();')) }}</div>
    <div class="col-md-9">
