...
@section('header')
<h1>Conductor Ledger Report</h1>
<ol class="breadcrumb">
            <li><a href="/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#"></i>Conductor Ledger</a></li>
            </ol>
@stop
@section('content')
<div class="row">
    <div class="col-md-12" style="min-height:10px;">
        <div class="box box-default" style="min-height:0px;">
            ...
            <div class="box-body">
                {!! Form::open([
                'route' => 'reports.revenue.conductor_ledger.displaydata',
                'files'=>true,
                ...
                @include('reports.revenue.conductor_ledger.form', ['submitButtonText' => Lang::get('user.headers.create_submit')])
...
$(document).ready(function(){
    $(document).on('click', '#exportAsPDF', function(){
        ...
        $.ajax({
            url: "{{route('reports.revenue.conductor_ledger.getpdfreport')}}",
            type: "POST",
            dataType: "JSON",
            data: {
                depot_id: depot_id,
    ...
    $(document).on('click', '#exportAsXLS', function(){
        ...
        var url = "{{route('reports.revenue.conductor_ledger.getexcelreport')}}"+queryParams;
