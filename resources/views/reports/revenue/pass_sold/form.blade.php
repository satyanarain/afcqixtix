<div class="row">
    ...
    <div class="col-md-3">
        @php $passTypes=displayList('pass_types','description')@endphp
        {!! Form::label('pass_id', Lang::get('Pass Type'), ['class' => 'control-label']) !!}
        {!! Form::select('pass_id',$passTypes, null, ['class' => ' form-control','placeholder'=>"All"]) !!}
    </div>
